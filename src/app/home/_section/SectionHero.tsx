...
export default function SectionHero() {
  return (
    <section className="w-full">
      ...
      <div className="relative w-full h-[400px] sm:h-[768px]">
        <div className="overflow-hidden bg-linear-2 from-[#5c6063] to-75% to-background absolute w-[calc(100vw-15px)] xl:w-[calc(100vw-25px)] max-w-480 h-full bottom-0 left-1/2 -translate-x-1/2 xl:rounded-b-md">
          <Image
            src="/Glow.png"
            loading="eager"
            fill
        ...
        <div className="relative size-full overflow-hidden">
          <div className="origin-top-left scale-50 sm:scale-100 absolute top-0 left-0 bg-bg-primary border border-border-primary w-[1346px] rounded-lg overflow-hidden flex text-[13px] p-2">
            {/* Left Sidebar */}
              ...
              <div className="flex-1">
                ...
                <div className="flex-1 min-h-0 p-10 overflow-hidden">
                  ...
                  <p className="px-4 text-text-tertiary leading-relaxed mb-6">
                    ...
                    <br /> instead of blocking on full refresh during iOS
                    startup.
                  </p>
              ...
              <div className="w-[330px] shrink-0 border-l border-border-primary flex flex-col gap-3">
                ...
                <div className="p-4">
                  ...
                  <div className="pt-4 flex items-center gap-1.5">
                    <div className="size-4.5 rounded-full bg-green-700 flex items-center justify-center font-bold text-white">
                      j
                    </div>
                    <span className="text-text-secondary ">jori</span>
                  </div>

                  <div className="pl-4 pt-2 flex items-center gap-1.5 mt-0.5">
                    <div className="size-5 rounded-full bg-bg-tertiary flex items-center justify-center">
            ...
            <div className="absolute bottom-4 right-4 w-[400px] bg-bg-primary border border-border-primary rounded-lg shadow-2xl text-[13px] overflow-hidden">
              {/* Header */}
